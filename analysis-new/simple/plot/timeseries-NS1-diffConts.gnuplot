...
INPUT_PATH="/mnt/data/resource/NS1-noCache"
OUTPUT_PATH="/mnt/data/resource/NS1-noCache"
...
do for [job_id=1:words(ARR_JOB_TYPE)] {
	do for [target_id=1:words(ARR_TARGET_TYPE)]{
		...
		TITLE=sprintf("%s-fio-%s-QD1-BS4k-NS1-noCache",word(ARR_TARGET_TYPE,target_id),word(ARR_JOB_TYPE,job_id))
